...
const Page = () => {
  return (
    <div className='p-4  max-w-screen-2xl mx-auto pt-16'>
      <a className="inline-block cursor-pointer rounded-full bg-gradient-to-r from-yellow-home7 from-10% via-orange-home7 via-50% to-orange-home7 to-100% px-8 py-4 text-sm font-medium text-white transition hover:bg-indigo-700 capitalize" href="/">Back to Home</a>
