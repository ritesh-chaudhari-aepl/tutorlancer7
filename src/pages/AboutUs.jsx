        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-12 lg:px-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-16">
            ...
            <div className="lg:py-16 text-center md:text-left">
              <h6 className="uppercase font-bold text-black">about us</h6>
              <h2 className="text-3xl capitalize font-bold sm:text-4xl text-black">
              ...
              <a
                href="#"
                className="mt-8 inline-block rounded-full bg-pink-darkPink px-12 py-3 text-sm font-medium text-black transition hover:bg-indigo-700 focus:outline-none focus:ring focus:ring-yellow-400"
              >
                Read More
              </a>
            </div>
